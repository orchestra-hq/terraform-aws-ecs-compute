...
| <a name="input_image_tags"></a> [image\_tags](#input\_image\_tags) | A map representing the ECR image tags to use for each integration. | `map(string)` | <pre>{<br/>  "bash": "2026.04.27-0",<br/>  "dbt_core": "2026.04.27-0",<br/>  "python": "2026.04.21-1"<br/>}</pre> | no |
| <a name="input_integrations"></a> [integrations](#input\_integrations) | The integrations to deploy. One of 'bash', 'dbt\_core' or 'python'. | `list(string)` | <pre>[<br/>  "python",<br/>  "dbt_core"<br/>]</pre> | no |
